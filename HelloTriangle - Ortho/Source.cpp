...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola Triangulo! -- Emanuele", nullptr, nullptr);
...
while (!glfwWindowShouldClose(window))
{
    ...
    // Definir e renderizar em cada quadrante:

    // Quadrante superior esquerdo
    glViewport(0, 300, 400, 300); // Definir a viewport
    glDrawArrays(GL_TRIANGLES, 0, 3); // Renderizar a cena

    // Quadrante superior direito
    glViewport(400, 300, 400, 300); // Definir a viewport
    glDrawArrays(GL_TRIANGLES, 0, 3); // Renderizar a cena

    // Quadrante inferior esquerdo
    glViewport(0, 0, 400, 300); // Definir a viewport
    glDrawArrays(GL_TRIANGLES, 0, 3); // Renderizar a cena

    // Quadrante inferior direito
    glViewport(400, 0, 400, 300); // Definir a viewport
    glDrawArrays(GL_TRIANGLES, 0, 3); // Renderizar a cena

    // Desconectar o buffer de geometria
    glBindVertexArray(0);
